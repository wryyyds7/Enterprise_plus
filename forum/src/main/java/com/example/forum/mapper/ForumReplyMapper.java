...
public interface ForumReplyMapper {
     ...
     * @return 论坛回复信息
     */
    ForumReply selectForumReplyById(@Param("replyId") Long replyId);
     ...
     * @return 结果
     */
    int deleteForumReplyById(@Param("replyId") Long replyId);
     ...
     * @return 结果
     */
    int deleteForumReplyByIds(@Param("replyIds") Long[] replyIds);
     ...
     * @return 子回复列表
     */
    List<ForumReply> selectChildReplyListByParentId(@Param("parentReplyId") Long parentReplyId);
     ...
     * @return 结果
     */
    int updateLikeCount(@Param("replyId") Long replyId, @Param("increment") int increment);
}
